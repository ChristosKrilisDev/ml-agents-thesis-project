...
namespace Unity.MLAgents.Tests
{
    public class StackingSensorTests
    {
        ...
        public void AssertStackingReset()
        {
            ...
            policy.OnRequestDecision = () => SensorTestHelper.CompareObservation(sensor, new[]
            {
                19f, 20f, 21f
            });
            agent1.EndEpisode();
        ...
        {
            var wrapped = new VectorSensor(2);
            var sensor = new StackingSensor(wrapped, 3);

            wrapped.AddObservation(new[]
            {
                1f, 2f
            });
            SensorTestHelper.CompareObservation(sensor, new[]
        ...
        private class Dummy3DSensor : ISensor
        {
        ...
        public void TestStackingMapping()
        {
            ...
            Assert.AreEqual(stackedCameraSensor.GetCompressionSpec().CompressedChannelMapping, new[]
            {
                0, 0, 0, 1, 1, 1
            });
            ...
            Assert.AreEqual(stackedRenderTextureSensor.GetCompressionSpec().CompressedChannelMapping, new[]
            {
                0, 1, 2, 3, 4, 5
            });
            ...
            dummySensor.Mapping = new[]
            {
                0, 1, 2, 3
            };
            var stackedDummySensor = new StackingSensor(dummySensor, 2);
            Assert.AreEqual(stackedDummySensor.GetCompressionSpec().CompressedChannelMapping, new[]
            {
            ...
            paddedDummySensor.Mapping = new[]
            {
                0, 1, 2, 3, -1, -1
            };
            var stackedPaddedDummySensor = new StackingSensor(paddedDummySensor, 2);
            Assert.AreEqual(stackedPaddedDummySensor.GetCompressionSpec().CompressedChannelMapping, new[]
            {
                0, 1, 2, 3, -1, -1, 4, 5, 6, 7, -1, -1
            });
        }
        ...
        public void TestStackedGetCompressedObservation()
        {
            ...
            expected1 = expected1.Concat(Array.ConvertAll(new[]
            {
                1f, 2f, 3f
            }, (z) => (byte)z)).ToArray();
            ...
            var expected2 = Array.ConvertAll(new[]
            {
                1f, 2f, 3f, 4f, 5f, 6f
            }, (z) => (byte)z);
            ...
            var expected3 = Array.ConvertAll(new[]
            {
                4f, 5f, 6f, 7f, 8f, 9f
            }, (z) => (byte)z);
            ...
            expected4 = expected4.Concat(Array.ConvertAll(new[]
            {
                10f, 11f, 12f
            }, (z) => (byte)z)).ToArray();
