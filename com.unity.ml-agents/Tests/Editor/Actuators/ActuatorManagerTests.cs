...
namespace Unity.MLAgents.Tests.Actuators
{
    ...
    public class ActuatorManagerTests
    {
        ...
        public void TestEnsureBufferSizeContinuous()
        {
            ...
            manager.ReadyActuatorsForExecution(new[]
                {
                    actuator1, actuator2
                },
        ...
        public void TestEnsureBufferDiscrete()
        {
            ...
            var actuator2 = new TestActuator(ActionSpec.MakeDiscrete(new[]
            {
                1, 1, 1
            }), "actuator2");
            manager.Add(actuator1);
        ...
        public void TestExecuteActionsContinuous()
        {
            ...
            var continuousActionBuffer = new[]
            {
                0f, 1f, 2f, 3f, 4f, 5f
            };
        ...
        private static void TestSegmentEquality<T>(ActionSegment<T> actionSegment, T[] actionBuffer)
            where T : struct
        {
        ...
        public void TestResetData()
        {
            ...
            Assert.IsTrue(manager.StoredActions.ContinuousActions.SequenceEqual(new[]
            {
                0f, 0f, 0f, 0f, 0f, 0f
            }));
        }
        ...
        public void TestWriteDiscreteActionMask()
        {
            ...
            var va1 = new TestActuator(ActionSpec.MakeDiscrete(new[]
            {
                1, 2, 3
            }), "name");
            var va2 = new TestActuator(ActionSpec.MakeDiscrete(new[]
            {
                3, 2, 1
            }), "name1");
            manager.Add(va1);
        ...
        public void TestHeuristic()
        {
            ...
            var actionBuf = new ActionBuffers(Array.Empty<float>(), new[]
            {
                0, 0, 0, 0, 0, 0, 0
            });
