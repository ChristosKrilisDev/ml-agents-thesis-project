...
namespace Unity.MLAgents.Editor
{
    ...
    */
    ...
    internal class BehaviorParametersEditor : UnityEditor.Editor
    {
        ...
        private const string k_BehaviorName = "m_BehaviorName";
        private const string k_BrainParametersName = "m_BrainParameters";
        private const string k_ModelName = "m_Model";
        private const string k_InferenceDeviceName = "m_InferenceDevice";
        private const string k_DeterministicInference = "m_DeterministicInference";
        private const string k_BehaviorTypeName = "m_BehaviorType";
        private const string k_TeamIdName = "TeamId";
        private const string k_UseChildSensorsName = "m_UseChildSensors";
        private const string k_ObservableAttributeHandlingName = "m_ObservableAttributeHandling";
        ...
        private void UpdateAgentPolicy()
        {
            var behaviorParameters = (BehaviorParameters)target;
